...
export const CompassIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1.41 13.59L12 12.17l-1.41 1.42-1.06-1.06L12 9.06l2.47 2.47-1.06 1.06z"/>
...
export const TransportIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M19 17h2v-5h-4v-1a2 2 0 00-2-2H7a2 2 0 00-2 2v1H1v5h2" />
    <path d="M19 17H5" />
...
export const FoodIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M3 11h18" />
    <path d="M12 2v9" />
    <path d="M19.78 12.22a4 4 0 11-15.56 0" />
...
export const RocketIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M13.5 18H11v-3.5L7.5 18H6v-6l4-2 4 2v6h-1.5v-3.5L13.5 18zM6 10l-3 1 1-4 2-2 3 3-3 2zM18 10l3 1-1-4-2-2-3 3 3 2z"/>
    <path d="M5 18h14"/>
  </svg>
);
...
export const BusIcon: React.FC<IconProps> = TransportIcon;
export const TrainIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M16 18V4a2 2 0 00-2-2H5a2 2 0 00-2 2v14" />
        <path d="M12 18V4" />
        <path d="M3 18h18" />
        <path d="M18 18v-2a2 2 0 00-2-2H8a2 2 0 00-2 2v2" />
        <circle cx="7.5" cy="18.5" r="1.5" />
        <circle cx="16.5" cy="18.5" r="1.5" />
    </svg>
);
export const AutoIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const RestaurantIcon: React.FC<IconProps> = FoodIcon;
export const ShopBagIcon: React.FC<IconProps> = ShopIcon;
...
export const CampusMapIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M14.5 14.5 21 21"/>
      <path d="M14 6a4 4 0 1 0-8 0 4 4 0 0 0 8 0z"/>
      <path d="M14 6h2a2 2 0 0 1 2 2v2"/>
      <path d="M10 14H8a2 2 0 0 1-2-2V8"/>
...
export const DoctorIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M5.5 21.5a.5.5 0 0 1-.5-.5v-13a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5v13a.5.5 0 0 1-.5.5h-13Z" />
        <path d="M12 12h-1v-1a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1h-1Z" />
        <path d="M12 12v1h1a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5h-1Z" />
        <path d="M12 12h1v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1h1Z" />
        <path d="M12 12v-1h-1a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h1Z" />
    </svg>
);
...
export const LocationPinIcon: React.FC<IconProps> = MapPinIcon;

export const CutleryIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M16 2H8C4.69 2 2 4.69 2 8v13a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V8c0-3.31-2.69-6-6-6zM12 12H2M12 12V2" />
        <path d="M16 12h6" />
        <path d="M16 12v10" />
    </svg>
);
